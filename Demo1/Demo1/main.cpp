...
int main(int argc, const char * argv[]) {
    ...
    */
    ...
    // 有符号数是所谓补码数
    // 正数用原码表示(即这个数的序号)。
    // 负数，用他的相反数（绝对值）的补码表示，补码的计算方法是:原码取反+1
    // 我的电脑是64位系统，int占8个字节，表示的最大整数是2^32-1 = 4294967295
    int a2 = -1; // -1的原码是10000000 00000000 00000000 00000001，补码是01111111 11111111 11111111 11111111，2^32 - 1 = 4294967295
    ...
    // 练习
    unsigned u = 10, u2 = 42;
    // -32原码是10000000 00000000 00000000 00100000，补码是01111111 11111111 11111111 11100000，2^32 - 32 = 4294967264
    std::cout << "10 - 42 = " << u - u2  << std::endl; // 计算结果被强制转换为unsigned int类型
    return 0;
}
